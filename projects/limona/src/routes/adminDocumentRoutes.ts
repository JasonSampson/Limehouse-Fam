...
adminDocumentRoutes.get("/api/admin/categories", asyncHandler(async (_req, res) => {
...
adminDocumentRoutes.get("/api/admin/documents/:id/download", asyncHandler(async (req, res) => {
  const result = await getPool().query(
